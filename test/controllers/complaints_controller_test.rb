...
class ComplaintsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create complaint" do
    assert_difference('Complaint.count') do
      post complaints_url, params: { complaint: { content: @complaint.content, recipient_id: @complaint.recipient_id, recipient_type: @complaint.recipient_type, sendable_id: @complaint.sendable_id, sendable_type: @complaint.sendable_type } }
    end
  ...
  test "should update complaint" do
    patch complaint_url(@complaint), params: { complaint: { content: @complaint.content, recipient_id: @complaint.recipient_id, recipient_type: @complaint.recipient_type, sendable_id: @complaint.sendable_id, sendable_type: @complaint.sendable_type } }
